...
class Signup extends React.Component {
    ...
    handleInput(e) {
        ...
        } else if (type === 'checkbox') { //valida si el checkbox cambió
            this.setState(update(this.state, {
    ...
    signup(e) {
        e.preventDefault() //evita que se mande una solicitud al servidor

        if (!this.state.license) {
            this.submitBtnLabel.innerHTML = 'Acepte los términos de licencia'
            this.submitBtnLabel.className = 'shake animated'
            return
        } else if (!this.state.userOk) {
            this.submitBtnLabel.innerHTML = 'Favor de revisar su nombre de usuario'

    ...
    return (
        <aside id="profile" className="twitter-panel">
            <div className="profile-banner">
                <Link to={"/" + props.profile.userName} className="profile-name" style={{ backgroundImage: (props.profile.banner != null ? `url('${props.profile.banner}')` : 'none') }} />
            </div>
            <div className="profile-body">
                <img className="profile-avatar" src={props.profile.avatar} />
                <Link to={"/" + props.profile.userName} className="profile-name">{props.profile.name}</Link>
                <Link to={"/" + props.profile.userName} className="profile-username"> @{props.profile.userName}</Link>
            </div>

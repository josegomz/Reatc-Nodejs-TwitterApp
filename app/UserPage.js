...
const UserPage = (props) =>{
    ...
    useEffect(() => {
        ...
        APIInvoker.invokeGET(`/profile/${username}`, response => {
          ...
          alert("Error al cargar los Tweets :) vales verch");
          //window.location = '/'
        })
                    ...
                    <div className="user-banner" style={{ backgroundImage: 'url(' + (profile.banner) + ')' }}>
                        <If condition={edit}>
                            <div>
                                ...
                                <input href="#" className="btn" accept=".gif,.jpg,.jpeg,.png" type="file" id="bannerInput"
                            ...
                            <div className="row">
                                ...
                                <div className="col-xs-12 col-sm-8 col-md-push-1 col-md-7 col-lg-push-1 col-lg-7">
                                    <ul className="user-summary-menu">
                                        <li>
                                        <NavLink to={`/${profile.userName}`} exact activeClassName="selected">
                                                <p className="summary-label">TWEETS</p>
                                                <p className="summary-value">{profile.tweetCount}</p>
                                            </NavLink>
                                        </li>
                                        <li>
                                        <NavLink to={`/${profile.userName}/following`} activeClassName="selected">
                                                <p className="summary-label">SIGUIENDO</p>
                                                <p className="summary-value">{profile.following}</p>
                                            </NavLink>
                                        </li>
                                        <li>
                                        <NavLink to={`/${profile.userName}/followers`} activeClassName="selected">
                                    ...
                                    <If condition={profile.userName === userContext.userName}>
                                        <button className="btn btn-primary edit-button" onClick={changeToEditMode} >
                                            {edit ? "Guardar" : "Editar perfil"}
                                        </button>
                                    </If>
                                    <If condition={profile.follow != null && profile.userName !== userContext.userName}>
                                        <button className="btn edit-button" onClick={follow} >
                                            {profile.follow
                                    ...
                                    <If condition={edit}>
                                        <button className="btn edit-button" onClick={cancelEditMode} >Cancelar</button>
                                    </If>
                        ...
                        <div className="hidden-xs col-sm-4 col-md-push-1 col-md-3 col-lg-push-1 col-lg-3" >
                            ...
                            <aside id="user-info">
                                <div className="user-avatar">
                                    <Choose>
                                        <When condition={edit} >
                                            <div className="avatar-box"> <img src={profile.avatar} /> <label htmlFor="avatarInput"
                                                className="btn select-avatar"> <i className="fa fa-camera fa-2x"
                                                    aria-hidden="true"></i> <p>Foto</p>
                                            </label>
                                                <input href="#" id="avatarInput"
                                                    className="btn" type="file" accept=".gif,.jpg,.jpeg,.png" onChange={imageSelect}
                                                /> </div>
                                        </When>
                                        <Otherwise>
                                ...
                                <Choose>
                                    <When condition={edit} >
                                        <div className="user-info-edit">
                                            ...
                                            <p className="user-info-username">@{profile.userName}</p> <textarea maxLength="180" id="description"
                                                value={profile.description} onChange={handleInput} />
                                    ...
                                    <Otherwise>
                                        <div>
                                            ...
                                            <p className="user-info-username">@{profile.userName}</p> <p className="user-info-description">

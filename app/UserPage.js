    ...
    changeToEditMode(e) {
        if (this.state.edit) {
            let request = {
                ...
                description: this.state.profile.description, avatar: this.state.profile.avatar,
                            ...
                            <div className="row">
                                ...
                                <div className="col-xs-12 col-sm-8 col-md-push-1 col-md-7 col-lg-push-1 col-lg-7">
                                    <ul className="user-summary-menu">
                                        <li>
                                            <NavLink to={`/${profile.userName}`} activeClassName="selected">
                                    ...
                                    <If condition={profile.userName === storageUserName}>
                                        <button className="btn btn-primary edit-button" onClick={this.changeToEditMode.bind(this)} >
                                            {this.state.edit ? "Guardar" : "Editar perfil"}
                                        </button>
                                    </If>
                                    ...
                                    <If condition={this.state.edit}>
                                        <button className="btn edit-button" onClick={this.cancelEditMode.bind(this)} >Cancelar</button>
                                    </If>
                                        ...
                                        <When condition={this.state.edit} >
                                            <div className="avatar-box"> <img src={profile.avatar} /> <label htmlFor="avatarInput"
                                                ...
                                                <input href="#" id="avatarInput"
                                                    className="btn" type="file" accept=".gif,.jpg,.jpeg,.png" onChange={this.imageSelect.bind(this)}
                                                /> </div>
                                        </When>
                                        <Otherwise>
                                    ...
                                    <When condition={this.state.edit} >
                                        <div className="user-info-edit">
                                            ...
                                            <p className="user-info-username">@{profile.userName}</p> <textarea maxLength="180" id="description"
                                                value={profile.description} onChange={this.handleInput.bind(this)} />
